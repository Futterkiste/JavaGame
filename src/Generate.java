...
public class Generate {
   ...
   static String paramFileName = "src/parameters.txt";
   static String propFileName = "level.properties";

   public static void setParamFileName(String name){paramFileName=name;}
   public static void setPropFileName (String name) {propFileName=name;}
